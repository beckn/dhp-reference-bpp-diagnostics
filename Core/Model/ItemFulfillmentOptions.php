...
class ItemFulfillmentOptions extends \Magento\Framework\Model\AbstractModel implements ItemFulfillmentOptionsInterface, IdentityInterface
{
    ...
    /**
     * @var ResourceModel\ItemFulfillmentTimes\CollectionFactory
     */
    ...
    public function __construct(
        ...
        \Beckn\Core\Model\ResourceModel\ItemFulfillmentTimes\CollectionFactory $itemFulfillmentTimesCollectionFactory,
        array $data = []
    )
    {
        $this->_itemFulfillmentTimesCollectionFactory = $itemFulfillmentTimesCollectionFactory;
    ...
    public function getItemFulfillmentTimes(){
        /**
         * @var \Beckn\Core\Model\ResourceModel\ItemFulfillmentTimes\Collection $timeCollection
         */
        $timeCollection = $this->_itemFulfillmentTimesCollectionFactory->create();
        $timeCollection->addFieldToFilter("fulfillment_option_id", $this->getEntityId());
